...
<body>
	...
	<?php
		$validForm = false; //form with or without errors	
	?>
		...
		<form>
			...
			<p>
				<label>Username: 
					<input type="text">	<span <?php echo ($validForm) ? "" : "class='errMsg'"; ?>></span>
				</label>
			</p>
			<p>
				<label>Password: 
					<input type="password">	<span <?php echo ($validForm) ? "" : "class='errMsg'"; ?>></span>
				</label>
			</p>	
			<p>
				<input type="submit">
